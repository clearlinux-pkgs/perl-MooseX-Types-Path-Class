...
cp %{_builddir}/MooseX-Types-Path-Class-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-MooseX-Types-Path-Class/f6392b1d37850a83994dc6347e3d15a6ff475a1c || :
if test -f Makefile.PL; then
